...
class ResearchTracker:
    ...
    def __init__(self):
        ...
        ] = {}  # Cache for extracted URLs from searches
    ...
    def start_round(self) -> int:
        ...
        self.rounds.append(
            {"round": self.current_round, "steps": [], "start_time": time.time()}
        )
    ...
    def get_summary(self) -> Dict[str, int]:
        ...
        return {
            ...
            "search_results": len(
                [r for r in self.results if r.get("tool") == "search"]
            ),
            "url_visits": len(
                [r for r in self.results if r.get("tool") == "visit_url"]
            ),
        }
        ...
        for result in self.results[-max_results:]:  # Last N results
            ...
            if tool == "search":
                ...
                if (
                    ...
                    and not content.startswith("URL must be")
                ):
