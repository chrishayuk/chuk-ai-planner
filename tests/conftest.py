...
session_mgr.models.session.SessionEvent = (
    MockSessionEvent  # Make SessionEvent available in session module too
)
...
sys.modules["chuk_session_manager.models.event_source"] = (
    session_mgr.models.event_source
)
sys.modules["chuk_session_manager.models.session_event"] = (
    session_mgr.models.session_event
)
...
sys.modules["chuk_session_manager.storage.providers.memory"] = (
    session_mgr.storage.providers.memory
)
...
sys.modules["chuk_tool_processor.execution.strategies.inprocess_strategy"] = (
    tool_proc.execution.strategies.inprocess_strategy
)
sys.modules["chuk_tool_processor.execution.tool_executor"] = (
    tool_proc.execution.tool_executor
)
