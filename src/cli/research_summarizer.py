        ...
        for result in tracker.results:
            ...
            if tool == "search":
                ...
                if (
                    ...
                    or content.startswith("URL must be")
                ):
                    continue
                ...
                if (
                    ...
                    any(
                        sm in url.lower()
                        for sm in ["twitter", "facebook", "linkedin", "instagram"]
                    )
                    or content_type == "social_media"
                ):
