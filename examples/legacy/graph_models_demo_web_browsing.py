...
def create_web_browsing_session():
    ...
    edges = [
        ...
        *[ParentChildEdge(src=task_runs[i].id, dst=step_summaries[i].id) 
        ...
        GraphEdge(kind=EdgeType.CUSTOM, src=browsing_tools[1].id, dst=browsing_tools[2].id,
                 data={"data_type": "extracted_articles", "flow_direction": "output_to_input"}),
        GraphEdge(kind=EdgeType.CUSTOM, src=browsing_tools[2].id, dst=browsing_tools[3].id,
                 data={"data_type": "filtered_articles", "flow_direction": "output_to_input"}),
        GraphEdge(kind=EdgeType.CUSTOM, src=browsing_tools[5].id, dst=browsing_tools[6].id,
